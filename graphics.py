...
class GraphWin(tk.Canvas):
    ...
    def __init__(self, title="Graphics Window",
        ...
        self.bind("<Button-3>", self._onRClick)
        self.bind_all("<Key>", self._onKey)
        self.height = int(height)
        self.width = int(width)
        self.autoflush = autoflush
        self._mouseCallback = None
        self._mouseRCallback = None
        self.trans = None
        self.closed = False
        master.lift()
        self.lastKey = ""
    ...
    def setMouseRHandler(self, func):
        self._mouseRCallback = func
    ...
    def _onRClick(self, e):
        self.mouseX = e.x
        self.mouseY = e.y
        self.mouseBtn = "R"
        if self._mouseRCallback:
            self._mouseRCallback(Point(e.x, e.y))
